...
export default function Component() {
  return (
    <div className='w-full flex flex-wrap justify-start items-center gap-8 '>
      <h2 className='w-full h-24 text-center font-semibold uppercase text-4xl'>
        Portal Informativo De Proyectos
      </h2>
      {/* Proyecto De Carrereteras*/}
      <div className='w-[80%] md:w-[26%] h-full md:h-1/2 flex flex-col mx-auto my-auto '>
